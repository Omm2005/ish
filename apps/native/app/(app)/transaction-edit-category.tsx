...
export default function TransactionEditCategoryScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const nextTx: TransactionPayload = { ...tx, category: value };
  ...
  return (
    ...
    >
      <View className="flex-row items-center justify-between">
        <Text className="text-base font-semibold text-foreground">Edit category</Text>
        <Pressable
          onPress={() => router.back()}
