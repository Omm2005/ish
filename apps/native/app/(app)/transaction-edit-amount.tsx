...
export default function TransactionEditAmountScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const nextTx: TransactionPayload = { ...tx, amount: value };
  ...
  return (
    ...
    >
      <View className="flex-row items-center justify-between">
        <Text className="text-base font-semibold text-foreground">Edit amount</Text>
        <Pressable
          onPress={() => router.back()}
